    ...
    <div class="container">
        <div class="row">
            <div class="page-header">
                <h1 style="text-align:center;">Trip Request</h1>
                 <?php //echo $msg; ?>
            </div>
            ...
            <div class="col-md-6">
                <form class="animated bounce" action="bookingaction.php" method="post">
                    ...
                    <div class="input-group">
                      ...
                      <label><input type="radio" name="type" value="car">Rav4</label> &nbsp;
                      <label><input type="radio" name="type" value="bus">Coaster</label>
                    </div>
                    <br>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                      ...
                      <input id="pickup" type="text" class="form-control" name="pickup" placeholder="">
                    </div>
                    <br>
