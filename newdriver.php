<?php
    ...
    if(isset($_POST['submit'])){
       ...
       move_uploaded_file($_FILES['file']['tmp_name'],"picture/".$_FILES['file']['name']); 
        ...
        $res=false;
        $insert_query="INSERT INTO `driver`(`driverid`, `drname`, `drjoin`, `drmobile`, `drnid`, `drlicense`, `drlicensevalid`, `drcategory`, `draddress`, `drphoto`) VALUES ('','$drname','$drjoin','$drmobile','$drnid','$drlicense','$drlicensevalid','$drcategory','$draddress','$drphoto')";
