...
if(isset($_POST['email'])) {
 ...
 /*
    ...
    $email_from = "yves1iriho@gmail.com"; // required
...
$update_query="UPDATE `booking` SET `confirmation`='0',`veh_reg`='$veh_reg',`driverid`='$driver_id' WHERE booking_id='$id'; UPDATE `vehicle` SET `veh_available`='0' WHERE veh_reg='$veh_reg';UPDATE `driver` SET `dr_available`='0' WHERE driverid='$driver_id'";
